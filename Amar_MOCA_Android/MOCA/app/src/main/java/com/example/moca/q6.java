...
public class q6 extends AppCompatActivity {
    ...
    private class PostRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                ...
                Toast.makeText(q6.this, "Error fetching questions", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseJsonResponse(String jsonResponse) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(q6.this, "Error parsing JSON response", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayQuestion(JSONObject questionObject) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(q6.this, "Error displaying question", Toast.LENGTH_SHORT).show();
        }
    }
