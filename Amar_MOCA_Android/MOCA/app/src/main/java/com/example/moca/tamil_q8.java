...
public class tamil_q8 extends AppCompatActivity {
    private Button[] optionButtons = new Button[4];
    private int selectedOptionIndex = -1;
    private int previousSelectedIndex = -1;
    int count , visual,naming,memory,attention,language=0;
    byte[] q2, q3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_q8);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionIndex == -1) {
                    Toast.makeText(tamil_q8.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                resetButtonColors();
                Intent intent = new Intent(tamil_q8.this, tamil_q9.class);
    ...
    private class PostRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                ...
                Toast.makeText(tamil_q8.this, "Error fetching questions", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseJsonResponse(String jsonResponse) {
        ...
        try {
            ...
            displayQuestion(questionsArray.getJSONObject(7));
        } catch (JSONException e) {
            e.printStackTrace();
            Toast.makeText(tamil_q8.this, "Error parsing JSON response", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayQuestion(JSONObject questionObject) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(tamil_q8.this, "Error displaying question", Toast.LENGTH_SHORT).show();
        }
    }
