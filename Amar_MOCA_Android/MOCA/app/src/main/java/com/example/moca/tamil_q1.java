...
public class tamil_q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_q1);
        Intent intent = getIntent();
        id=intent.getStringExtra("id");
        qno = findViewById(R.id.question_no1);
        topic = findViewById(R.id.ques_type1);
        question = findViewById(R.id.question_1);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionIndex == -1) {
                    Toast.makeText(tamil_q1.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                resetButtonColors();
                Intent intent = new Intent(tamil_q1.this, tamil_q2.class);
    ...
    private class PostRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                ...
                Toast.makeText(tamil_q1.this, "Error fetching questions", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseJsonResponse(String jsonResponse) {
        ...
        try {
            ...
            displayQuestion(questionsArray.getJSONObject(0));
        } catch (JSONException e) {
            e.printStackTrace();
            Toast.makeText(tamil_q1.this, "Error parsing JSON response", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayQuestion(JSONObject questionObject) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(tamil_q1.this, "Error displaying question", Toast.LENGTH_SHORT).show();
        }
    }
