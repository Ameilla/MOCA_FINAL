...
public class tamil_q7 extends AppCompatActivity {
    ...
    int count , visual,naming,memory,attention;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_q7);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionIndex == -1) {
                    Toast.makeText(tamil_q7.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                resetButtonColors();
                Intent intent = new Intent(tamil_q7.this, tamil_q8.class);
    ...
    private class PostRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                ...
                Toast.makeText(tamil_q7.this, "Error fetching questions", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseJsonResponse(String jsonResponse) {
        ...
        try {
            ...
            displayQuestion(questionsArray.getJSONObject(6));
        } catch (JSONException e) {
            e.printStackTrace();
            Toast.makeText(tamil_q7.this, "Error parsing JSON response", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayQuestion(JSONObject questionObject) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(tamil_q7.this, "Error displaying question", Toast.LENGTH_SHORT).show();
        }
    }
