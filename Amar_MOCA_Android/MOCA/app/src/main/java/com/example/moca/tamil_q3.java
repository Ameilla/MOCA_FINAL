...
public class tamil_q3 extends AppCompatActivity {
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_q3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tamil_q3 = convertBitmapToByteArray(drawingBitmap);

                // Pass the byte array to the next activity
                Intent intent = new Intent(tamil_q3.this, tamil_q4.class);
                intent.putExtra("q2", q2);
                intent.putExtra("id",id);
                intent.putExtra("tamil_q3", tamil_q3);
    ...
    private class PostRequestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String jsonResponse) {
            if (jsonResponse != null) {
                ...
                Toast.makeText(tamil_q3.this, "Error fetching questions", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void parseJsonResponse(String jsonResponse) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(tamil_q3.this, "Error parsing JSON response", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void displayQuestion(JSONObject questionObject) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(tamil_q3.this, "Error displaying question", Toast.LENGTH_SHORT).show();
        }
    }
